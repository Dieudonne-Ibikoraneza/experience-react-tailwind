...
const Navbar = () => {
  ...
  return (
    <div className='absolute w-full flex justify-between p-4 items-center'>
        <h1 className='text-gray-300 fixed left-8 top-4 font-bold text-2xl z-20'>Experiences</h1>
        <HiMenuAlt3 onClick={handleNav} size={25} className='z-20 text-white fixed right-4 top-4 cursor-pointer'/>
